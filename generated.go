...
func (ec *executionContext) _Mutation_createSupplier(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalOSupplier2ᚖlabxsubsᚐSupplier(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_suppliers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNSupplier2ᚕᚖlabxsubsᚐSupplier(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Supplier_code(ctx context.Context, field graphql.CollectedField, obj *Supplier) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _Supplier_accesses(ctx context.Context, field graphql.CollectedField, obj *Supplier) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _Supplier(ctx context.Context, sel ast.SelectionSet, obj *Supplier) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "accesses":
			out.Values[i] = ec._Supplier_accesses(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "createdAt":
...
func (ec *executionContext) marshalNSupplier2labxsubsᚐSupplier(ctx context.Context, sel ast.SelectionSet, v Supplier) graphql.Marshaler {
	return ec._Supplier(ctx, sel, &v)
}

func (ec *executionContext) marshalNSupplier2ᚕᚖlabxsubsᚐSupplier(ctx context.Context, sel ast.SelectionSet, v []*Supplier) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOSupplier2ᚖlabxsubsᚐSupplier(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNSupplier2ᚖlabxsubsᚐSupplier(ctx context.Context, sel ast.SelectionSet, v *Supplier) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOSupplier2labxsubsᚐSupplier(ctx context.Context, sel ast.SelectionSet, v Supplier) graphql.Marshaler {
	return ec._Supplier(ctx, sel, &v)
}

func (ec *executionContext) marshalOSupplier2ᚖlabxsubsᚐSupplier(ctx context.Context, sel ast.SelectionSet, v *Supplier) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Supplier(ctx, sel, v)
